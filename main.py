...
# ✅ Trailer route used by Streamlit: /movie/trailer/{tmdb_id}
@app.get("/movie/trailer/{tmdb_id}")
async def get_trailer(tmdb_id: int):
    """
    Returns YouTube trailer key using TMDB /videos.
    Prefers Trailer, falls back to Teaser.
    """
    ...
    return {"youtube_key": trailer_key}
